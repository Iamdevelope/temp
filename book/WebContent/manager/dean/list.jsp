...
<script type="text/javascript">
	$(function(){
		...
		$('#downloadData').on('click',function(){
			window.location.href = "${pageContext.request.contextPath}/deanManager";
		});
		...
		$('input#selectBtn').on('click',function(){
			...
			window.location.href="${pageContext.request.contextPath}/deanManager_select?page=1&select="+select;
		});
	});
...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/Manager/dean/list.jsp"
		method="post">
			...
			<TBODY>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="d" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 30px" align="center"
										width="8%"><a
										href="${pageContext.request.contextPath }/deanManager_info?did=<s:property value="#d.did"/>">
									...
									<td align="center" style="HEIGHT: 30px"><a
										href="${ pageContext.request.contextPath }/deanManager_editPage?did=<s:property value="#d.did"/>">
											<img
									...
									<%-- <td align="center" style="HEIGHT: 30px"><a
										href="${ pageContext.request.contextPath }/deanManager_delete?did=<s:property value="#d.did"/>">
											<img
				...
				<tr align="center">
					<td colspan="7"><s:if test="pageBean.totalCount>0">
								...
								<a
									href="${ pageContext.request.contextPath }/deanManager_findDeanAll?page=1">首页</a>|
									<a
									href="${ pageContext.request.contextPath }/deanManager_findDeanAll?page=<s:property value="pageBean.page-1"/>">上一页</a>|
								</s:if>
							<s:if test="pageBean.page != pageBean.totalPage">
								<a
									href="${ pageContext.request.contextPath }/deanManager_findDeanAll?page=<s:property value="pageBean.page+1"/>">下一页</a>|
									<a
									href="${ pageContext.request.contextPath }/deanManager_findDeanAll?page=<s:property value="pageBean.totalPage"/>">尾页</a>
								</s:if>
						</s:if> 
						<div>
	...
	<div class="easyui-dialog" title="导入Excel数据" id="importModel" draggable=true modal=true closed=true style="display:black;width:350px;height:200px" >
		<form id="importForm" action="${pageContext.request.contextPath }/deanManager_importData" enctype="multipart/form-data" method="post">
    		<table>
    			<tr>
    				<td>浏览:</td>
    				<td>
	...
	<div id="mm2" style="width:12%;">
		<div id="addPage">
			<a title="新增一个园长信息" >新增院长</a>
		</div>
		<div id="importBtn">
			<a title="导入园长信息">导入数据</a>
		</div>
	</div>
</body>
</HTML>
