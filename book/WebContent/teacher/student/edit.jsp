...
<body>
	<form id="studentTeacher_save_do" name="Form1"
		action="${pageContext.request.contextPath}/studentTeacher_update"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					班主任：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="teacher.getName()" value="<s:property value="model.teacher.getName()"/>"
					id="studentTeacher_save_do_logonName" class="bg"
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit" id="studentTeacher_save_do_submit" value="确定"
