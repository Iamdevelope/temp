...
<link href="${pageContext.request.contextPath }/css/bookInfo.css"
	...
	<script type="text/javascript">
		function show(){
			...
			window.location.href="${pageContext.request.contextPath}/bookTeacher_show?bid="+bid+"&btype="+btype;
			
		}
		function load(){
			var img=document.getElementById("fengmian");
			var name=document.getElementById("book_name").value;
			img.src="../book/bookImages/"+name+"/fengmian.jpg";
		}
	</script>
</HEAD>
...
<div>
	<div class="book">
		<a href="${ pageContext.request.contextPath }/bookTeacher_show?bid=<s:property value="model.bid"/>&btype=<s:property value="model.type"/>">
	...
	<div class="book_context">
		<form id="bookSuperManager_save_do" name="Form1">
			...
			<input type="hidden" id="btype" value="<s:property value="model.type"/>" />
			<input type="hidden" id="book_name" value="<s:property value="model.name"/>" />
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" height="30%" align="center"
				...
				<tr>
					...
					<td bgColor="#ffffff" style="align: left;"><textarea rows="5"
							cols="30" name="book_type" readonly="readonly"><s:property
