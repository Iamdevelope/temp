							...
							<tbody>
								...
								<tr>
									...
									<td><span> <input
										...
										<span class="STYLE11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;园长 <label>
										<input style="height: 20px; width: 20px;" type="radio" id="identity" name="dean" value="dean"
											checked />
										</label> &nbsp;&nbsp; 教师 <label>
											<input style="height: 20px; width: 20px;" type="radio" id="identity" name="teacher" value="teacher" />
										</label>
										</span>
									</td>
								</tr>
