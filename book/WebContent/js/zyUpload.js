	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					...
					url              : "${pageContext.request.contextPath}/teachingPlan_importWordData",  	// 上传文件的路径
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				}else if(file.type.indexOf("docx")>0||file.type.indexOf("doc")>0){
					fileImgSrc = fileImgSrc + "word.jpg";
				}
				else{
