...
<script type="text/javascript">
			function updatePasswordPage(){
				window.location.href="${pageContext.request.contextPath}/superManager_updatePasswordPage";
			}
			function edit(){
				window.location.href="${pageContext.request.contextPath}/superManager_edit";
			}
		</script>
</HEAD>
...
<body>
	<form id="superManager_save_do" name="Form1">
		<input type="hidden" id="aid" name="aid"
			value="<s:property value="#session.existAdmin.aid"/>" /> &nbsp;
