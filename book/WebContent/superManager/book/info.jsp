...
<script type="text/javascript">
			function show(){
				...
				window.location.href="${pageContext.request.contextPath}/bookSuperManager_show?bid="+bid+"&btype="+type;
			}
			function load(){
...
<div>
	<div class="book">
		<a
			href="${ pageContext.request.contextPath }/bookSuperManager_show?bid=<s:property value="model.bid"/>&btype=<s:property value="model.type"/>">
