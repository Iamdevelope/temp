							...
							<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
								...
								<tr>
									<td height="550">
										...
										<!-- <iframe src='https://view.officeapps.live.com/op/view.aspx?src=http://47.102.133.243/book/teachingplans/后台.xls' width='100%' height='100%' frameborder='1'>
										</iframe> -->
									</td>
								</tr>
							</table>
...
function loadPage(){
	...
	img.src="../book/bookImages/"+book_type+"/"+name+"/01.jpg";
