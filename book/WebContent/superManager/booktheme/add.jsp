...
<script type="text/javascript">
			function keypress(){
				var text1=document.getElementById("theme_description").value;
				var len;
				if(text1.length>=300){
					document.getElementById("theme_description").value=text1.substr(0,300);
					len=0;
				}
				else{
				...
				document.getElementById("description").innerText=show;
			}
		</script>
</HEAD>
		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>添加绘本主题</STRONG> </strong></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="theme_name" value="" id="bookSuperManager_save_do_logonName"
					class="bg" /></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><textarea
						id="theme_description" rows="5" cols="30" name="theme_description"
