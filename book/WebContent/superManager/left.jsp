...
<body>
	...
	<table width="100%" border="0">
		<tr>
			<td>
				<div class="dtree">
					...
					<script type="text/javascript">
					var manager = "<%=session.getAttribute("existAdmin") %>";
					console.log("管理员为："+manager.name);
		d = new dTree('d');
		d.add('01',-1,'系统菜单');
		...
		d.add('0104020101','01040201','社会','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=1&page=1','','mainFrame');
		d.add('01040202','010402','科学');
		d.add('0104020201','01040202','数学','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=2&page=1','','mainFrame');
		d.add('0104020202','01040202','探究','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=3&page=1','','mainFrame');
		d.add('01040203','010402','艺术');
		d.add('0104020301','01040203','美术','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=4&page=1','','mainFrame');
		d.add('0104020302','01040203','音乐','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=5&page=1','','mainFrame');
		d.add('01040204','010402','健康');
		d.add('0104020401','01040204','健康','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=6&page=1','','mainFrame');
		d.add('01040205','010402','健康');
		d.add('0104020501','01040205','语言','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=7&page=1','','mainFrame');
		
		/* d.add('010402','0104','社会');
		d.add('010403','010402','社会','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=1&page=1','','mainFrame');
		d.add('010404','0104','科学');
		d.add('010405','010404','数学','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=2&page=1','','mainFrame');
		d.add('010406','010404','探究','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=3&page=1','','mainFrame');
		d.add('010407','0104','艺术');
		d.add('010408','010407','美术','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=4&page=1','','mainFrame');
		d.add('010409','010407','音乐','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=5&page=1','','mainFrame');
		d.add('010410','0104','健康');
		d.add('010411','010410','健康','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=6&page=1','','mainFrame');
		d.add('010412','0104','语言');
		d.add('010413','010412','语言','${pageContext.request.contextPath}/bookSuperManager_findBookAll?btype=7&page=1','','mainFrame'); */
		d.add('010414','0104','绘本类型管理','${pageContext.request.contextPath}/bookTypeSuperManager_booktype?page=1','','mainFrame');
		d.add('010415','0104','绘本主题管理','${pageContext.request.contextPath}/bookThemeSuperManager_booktheme?page=1','','mainFrame');
