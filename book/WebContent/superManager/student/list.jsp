...
$(function(){
	...
	$('#downData').on('click',function(){
		window.location.href = "${pageContext.request.contextPath}/studentSuperManager";
	});
...
function check_student_data(){
	var student_name=document.getElementById("studentSuperManager_save_do_name").value;
	var student_school=document.getElementById("studentSuperManager_save_do_school").value;
	var student_birthday=document.getElementById("studentSuperManager_save_do_birthday").value;
...
<div>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3">
						 <div class="excelBtn">
							...
							<a class="importId icon-add" style="padding-left:20px;" id="md2" iconCls="icon-add" title="导入学生信息" >导入数据</a>
						</div>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="s" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<c:if test="${existAdmin.isadmin==0 }">
										<td align="center" style="HEIGHT: 30px"><a
											href="${ pageContext.request.contextPath }/studentSuperManager_delete?sid=<s:property value="#s.sid"/>">
												<img
	...
	<div class="easyui-dialog" title="导入Excel数据" id="importModel" draggable=true modal=true closed=true style="display:black;width:350px;height:200px" >
		<form id="importForm" action="${pageContext.request.contextPath }/studentSuperManager_importData" enctype="multipart/form-data" method="post">
    		<table>
    			<tr>
    				<td>浏览:</td>
    				<td>
	...
	<div class="easyui-dialog" title="新增学生数据" id="addModel" draggable=true modal=true closed=true style="display:black;width:630px;height:230px" >
		<form id="studentSuperManager_save_do" name="Form1"
		action="${pageContext.request.contextPath}/studentSuperManager_save"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" value="" id="studentSuperManager_save_do_name"
					class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="date"
					name="birthday" value="" id="studentSuperManager_save_do_birthday"
					class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					<span style="color: red;">*</span>学校：
				</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="school" value="" id="studentSuperManager_save_do_school"
					class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					id="studentSuperManager_save_do_logonName" class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					用户名：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="username" value="" id="studentSuperManager_save_do_logonName"
					class="bg" /></td>
			</tr>
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					bgColor="#f5fafe" colSpan="4">
					<button type="submit" id="studentSuperManager_save_do_submit"
