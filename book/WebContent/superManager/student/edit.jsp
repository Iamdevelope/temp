...
<body>
	<form id="studentSuperManager_save_do" name="Form1"
		action="${pageContext.request.contextPath}/studentSuperManager_update"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					父亲姓名：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="father_name" value="<s:property value="model.father_name"/>"
					id="studentSuperManager_save_do_logonName" class="bg" /></td>
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					父亲电话：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="father_number" value="<s:property value="model.father_number"/>"
					id="studentSuperManager_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					母亲姓名：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="mother_name" value="<s:property value="model.mother_name"/>"
					id="studentSuperManager_save_do_logonName" class="bg" /></td>
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					母亲电话：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="mother_number" value="<s:property value="model.mother_number"/>"
					id="studentSuperManager_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					班主任：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="teacher.getName()" value="<s:property value="model.teachr.getName()"/>"
					id="studentSuperManager_save_do_logonName" class="bg"
