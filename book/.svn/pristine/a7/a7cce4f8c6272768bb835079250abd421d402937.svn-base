...
<script type="text/javascript">
			function back(){
				window.location.href="${pageContext.request.contextPath}/managerSuperManager_listPage";
			}
		</script>
</HEAD>

<body>
	<form id="managerSuperManager_edit_do" name="Form1"
		action="${pageContext.request.contextPath}/managerSuperManager_update"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					id="managerSuperManager_edit_do_logonName" class="bg" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><select name="isdelete">
						<option value="0" <s:if test="model.isdelete==0">selected</s:if>>是</option>
						<option value="1" <s:if test="model.isdelete==1">selected</s:if>>否</option>
				</select></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					id="managerSuperManager_edit_do_logonName" class="bg"
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit" id="managerSuperManager_edit_do_logonName"
						value="确定" class="button_ok">&#30830;&#23450;</button> <FONT
					face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
					<button type="reset" value="重置" class="button_cancel">&#37325;&#32622;</button>

					<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT> <INPUT
					class="button_ok" type="button" onclick="back()" value="返回" /> <span
					id="Label1"></span>
				</td>
			</tr>
		</table>
