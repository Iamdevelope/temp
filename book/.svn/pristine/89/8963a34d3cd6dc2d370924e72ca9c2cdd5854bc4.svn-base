...
<body>
	<form id="teacherDean_save_do" name="Form1"
		action="${pageContext.request.contextPath}/teacherDean_update"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					id="teacherDean_save_do_logonName" class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					密码：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					id="teacherDean_save_do_logonName" class="bg" readonly="readonly" />
				</td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					电话：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="phone" value="<s:property value="model.phone_number"/>"
					id="teacherDean_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					注册人：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="dean" value="<s:property value="model.dean.getName()"/>"
					id="teacherDean_save_do_logonName" class="bg" readonly="readonly" />
				</td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					最近登录时间：</td>
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit" id="teacherDean_save_do_submit" value="确定"
