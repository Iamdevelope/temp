...
<script type="text/javascript">
			function updatePasswordPage(){
				window.location.href="${pageContext.request.contextPath}/teacher_updatePasswordPage";
			}
			function edit(){
				window.location.href="${pageContext.request.contextPath}/teacher_editPage";
			}
		</script>
</HEAD>
...
<body>
	<form id="superManager_save_do" name="Form1">
		<input type="hidden" id="aid" name="aid"
			value="<s:property value="#session.existAdmin.tid"/>" /> &nbsp;
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>教师用户信息</STRONG> </strong></td>
			</tr>
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					班级：</td>
				<td class="ta_01" bgColor="#ffffff"><s:property
						value="#session.existAdmin.class_type" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					学校：</td>
