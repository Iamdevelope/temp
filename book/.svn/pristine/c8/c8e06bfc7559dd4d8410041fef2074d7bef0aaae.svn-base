...
<script type="text/javascript">
	$(function(){
		...
		$('#downData').on('click',function(){
			window.location.href = "${pageContext.request.contextPath}/studentDean";
		});
	...
	function check_student_data(){
		var student_name=document.getElementById("studentDean_save_do_name").value;
		var student_school=document.getElementById("studentDean_save_do_school").value;
		var student_birthday=document.getElementById("studentDean_save_do_birthday").value;
...
<div>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="s" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 30px" align="center"
										width="17%"><s:property value="#s.class_type" /></td>
									<td style="CURSOR: hand; HEIGHT: 30px" align="center"
	...
	<div class="easyui-dialog" title="导入Excel数据" id="importModel" draggable=true modal=true closed=true style="display:black;width:350px;height:200px" >
		<form id="importForm" action="${pageContext.request.contextPath }/studentDean_importData" enctype="multipart/form-data" method="post">
    		<table>
    			<tr>
    				<td>浏览:</td>
    				<td>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" value="" id="studentDean_save_do_name"
					class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="date"
					name="birthday" value="" id="studentDean_save_do_birthday"
					class="bg" /></td>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					<span style="color: red;">*</span>学校：
				</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="school" value="" id="studentDean_save_do_school"
					class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit" id="studentDean_save_do_submit"
