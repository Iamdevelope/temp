	...
	<div class="container login">
		...
		<div class="span12 last">
			<div class="wrap">
				<dir class="main">
					<div class="title">
						<strong>超级管理员登录</strong>MANAGER LOGIN
					</div>
					<div>
						<span style="color: red;"><s:actionerror /></span>
					</div>
					<form id="loginForm"
						action="${pageContext.request.contextPath }/superManager_login"
						method="post" novalidate="novalidate"
						onsubmit="return userCheck();">
						<table>
							<tbody>
								<tr>
									<th><font color="black">用户名：</font></th>
									<td><input type="text" id="name" name="name" class="text"
										maxlength="20"></td>
								</tr>
								<tr>
									<th><font color="black">密&nbsp;&nbsp;码：</font></th>
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off"> <a
											href="${pageContext.request.contextPath}/superManager_forgetPassword"><span
												style="color: red">忘记密码?</span></a></td>
								</tr>
								<tr>
									<th><span style="color: red">*</span><font color="black">验证码:</font>
									</th>
								...
								<tr>
									<th><font color="black">记住密码：</font></th>
									<td><span> <input
