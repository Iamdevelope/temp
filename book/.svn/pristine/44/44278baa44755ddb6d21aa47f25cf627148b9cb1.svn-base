...
<script type="text/javascript">
			function updatePasswordPage(){
				window.location.href="${pageContext.request.contextPath}/manager_updatePasswordPage";
			}
			function edit(){
				window.location.href="${pageContext.request.contextPath}/manager_editPage";
			}
		</script>
</HEAD>
...
<body>
	<form id="superManager_save_do" name="Form1">
		<input type="hidden" id="aid" name="mid"
			value="<s:property value="#session.existAdmin.mid"/>" /> &nbsp;
