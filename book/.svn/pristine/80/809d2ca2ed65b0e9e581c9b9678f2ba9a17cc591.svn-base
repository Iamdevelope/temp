		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>管理员用户信息</STRONG> </strong></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<s:property value="model.phone_number" />
				</td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<s:property value="model.last_login_time" />
				</td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff">
					<s:property value="model.login_count" />
				</td>
			</tr>
			<tr>
