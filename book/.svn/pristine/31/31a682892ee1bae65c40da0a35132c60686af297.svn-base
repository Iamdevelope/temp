...
<script type="text/javascript">
			function okBtn(){
				...
				// 3.打开连接
				xhr.open("GET","${pageContext.request.contextPath}/superManager_updatePassword?pwd="+oldpassword+"&newpwd="+password,true);
				// 4.发送
				xhr.send(null);
	...
	<form id="superManager_edit_do" name="Form1">
		...
		<table cellSpacing="1" cellPadding="5" width="30%" align="center"
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="text" name="oldpassword"
			...
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe">再次输入新密码：</td>
				<td bgColor="#ffffff"><input type="text" name="repassword"
					id="repassword" class="bg" /></td>
			</tr>
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					bgColor="#f5fafe" colSpan="4">
					<button type="button" id="superManager_edit_do_submit" value="确定"
