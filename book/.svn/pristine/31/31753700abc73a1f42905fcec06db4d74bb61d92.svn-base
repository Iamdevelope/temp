						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="b" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 30px" align="center"
										width="17%"><a
										href="${pageContext.request.contextPath }/bookTeacher_info?bid=<s:property value="#b.bid"/>&btype=<s:property value="type"/>">
									...
									<td style="CURSOR: hand; HEIGHT: 30px" align="center"
										width="8%">
										<%-- <div class="star">
													<img style="background-position:0 -25px;" alt="星星" src="${pageContext.request.contextPath}/images/xing.png">
													<img style="background-position:0 -25px;" alt="星星" src="${pageContext.request.contextPath}/images/xing.png">
													<img style="background-position:0 -25px;" alt="星星" src="${pageContext.request.contextPath}/images/xing.png">
													<img style="background-position:0 -25px;" alt="星星" src="${pageContext.request.contextPath}/images/xing.png">
													<img style="background-position:0 -25px;" alt="星星" src="${pageContext.request.contextPath}/images/xing.png">
												</div> --%> <s:property value="#b.score" />
									</td>
									<td align="center" style="HEIGHT: 30px"><s:if
											test="#b.isadd==0">
													已添加
												</s:if> <s:else>
											<a
												href="${ pageContext.request.contextPath }/bookTeacher_add?bid=<s:property value="#b.bid"/>">
