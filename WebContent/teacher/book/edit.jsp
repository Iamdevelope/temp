...
<body>
	<form id="bookTeacher_save_do" name="Form1"
		action="${pageContext.request.contextPath }/bookTeacher_update"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="text" name="name"
					...
					id="bookTeacher_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="text" name="book_used_time"
					...
					id="bookTeacher_save_do_logonName" class="bg" readonly="readonly" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgColor="#ffffff"><textarea id="book_abstract" rows="5"
						cols="30" name="book_abstract" onKeyDown="keypress()"
						onblur="keypress()"><s:property
							value="model.book_abstract" /></textarea> <font color="gray"><label
						id="abstract"></label></font> <%-- <input type="text" name="book_type" value="<s:property value="model.book_abstract"/>" id="bookSuperManager_save_do_logonName" class="bg"/> --%>
				</td>
			</tr>
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					bgColor="#f5fafe" colSpan="4">
					<button type="submit" id="bookTeacher_save_do_submit" value="确定"
