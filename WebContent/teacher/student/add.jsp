		...
		<table cellSpacing="1" cellPadding="5" width="50%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="date"
					name="birthday" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="father_name" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="father_number" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="mother_name" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="mother_number" value="" id="studentTeacher_save_do_logonName"
					class="bg" /></td>
			</tr>
			<tr>
				<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
