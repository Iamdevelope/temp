...
<body>
	...
	<table width="100%" border="0">
		...
		d.add('010203','010202','社会','${pageContext.request.contextPath}/bookDean_findBookAll?btype=0&page=1','','mainFrame');
		d.add('010204','0102','科学');
		d.add('010205','010204','数学','${pageContext.request.contextPath}/bookDean_findBookAll?btype=1&page=1','','mainFrame');
		d.add('010206','010204','探究','${pageContext.request.contextPath}/bookDean_findBookAll?btype=2&page=1','','mainFrame');
		d.add('010207','0102','艺术');
		d.add('010208','010207','美术','${pageContext.request.contextPath}/bookDean_findBookAll?btype=3&page=1','','mainFrame');
		d.add('010209','010207','音乐','${pageContext.request.contextPath}/bookDean_findBookAll?btype=4&page=1','','mainFrame');
		d.add('010210','0102','健康');
		d.add('010211','010210','健康','${pageContext.request.contextPath}/bookDean_findBookAll?btype=5&page=1','','mainFrame');
		d.add('010212','0102','语言');
		d.add('010213','010212','语言','${pageContext.request.contextPath}/bookDean_findBookAll?btype=6&page=1','','mainFrame');
